...
function downloadRows(forecast: ForecastResult) {
  ...
  anchor.href = url
  anchor.download = `openwind_${forecast.issue_date}_${forecast.variant}_48h.csv`
  anchor.click()
