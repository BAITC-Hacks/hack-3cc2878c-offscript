...
def create_app(*, repo_root: Path | None = None) -> FastAPI:
    ...
    app = FastAPI(title="OpenWind API", version="0.1.0", description="Agentic wind-farm forecasting with a configured Previous Runs availability check and tamper-evident ledger; provider release times are not verified.", lifespan=lifespan)
